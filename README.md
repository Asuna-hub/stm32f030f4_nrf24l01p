...
В заголовочном файле nrf24.h представлены маски регистров и битов nrf24, объявления необходимых функций, команды и некоторые вспомогательные вещи. Также там есть структуры регистров, которые упрощают отладку датчика. 
